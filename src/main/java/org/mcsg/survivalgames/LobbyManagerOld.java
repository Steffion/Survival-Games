    ...
    public void updateGameStatus() {
        ...
        for (int a = 0; a < games.size(); a++) {
            try {
                ...
                signs[b][0].setLine(0, ChatColor.GOLD + "[" + ChatColor.RED + "MCHG" + ChatColor.GOLD + "]");
                signs[b][0].setLine(1, ChatColor.AQUA + "Click to join");
                signs[b][0].setLine(2, ChatColor.GREEN + "Arena " + game.getID());
